          ...
          <el-table :data="manyTableData" border stripe>
            ...
            <el-table-column label="操作">
              <template slot-scope="scope">
                ...
                >编辑</el-button>
                <el-button
                  @click="deleteEditDiolog(scope.row.attr_id)"
                  type="danger"
                  size="mini"
                  icon="el-icon-delete"
                >删除</el-button>
...
export default {
  ...
  data() {
    return {
      ...
      // 添加表单的验证规则对象
      addFormRules: {
        attr_name: [{ required: true, trigger: 'blur' }]
      },
      // 修改对话框的显示
  ...
  computed: {
    ...
    titleText() {
      if (this.activeName === 'many') {
        this.addFormRules.attr_name[0].message = '请输入动态参数'
        this.editFormRules.attr_name[0].message = '请输入动态参数'
        return '动态参数'
      }
      this.addFormRules.attr_name[0].message = '请输入静态属性'
      this.editFormRules.attr_name[0].message = '请输入静态属性'
      return '静态属性'
    }
  }
}
